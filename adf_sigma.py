...
n_beads_tot = 40 # total number of beads in the system
beads_chain = 10 # number of beads per chain
f1= 15
f2= 31 # Frame to be analysed
num_frames = 1 # number of frames on which perform the analysis
chain_an = 4 # which chain? 1,2,3,4
...
with open('dump_hel.lammpstrj', 'r') as file:
